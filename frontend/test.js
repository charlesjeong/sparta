...
for(let i=0;i<scores.length;i++){
    ...
    if(scores[i].score > 80) {
        console.log("성적 우수자", name,":", score)
    }
    else{
        console.log("쓰레기", name,":", score)
    }
}
...
for(let i=0;i<bikes.length;i++){
    let bike_count = bikes[i]["parkingBikeTotCnt"]
    let stationName = bikes[i]["stationName"]
    if(bike_count > 20){
        console.log(stationName,bikes[i])
    }
}